export default function StatusBadge({ status }) {
  const config = {
    ...
    archived:  { bg: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-200', label: 'Archived' },
    expired:   { bg: 'bg-red-50', text: 'text-red-700', border: 'border-red-200', label: 'Expired' },
    invalid:   { bg: 'bg-red-50', text: 'text-red-700', border: 'border-red-200', label: 'Invalid' },
